...
TK_ERROR = getattr(tk, "TclError", RuntimeError)  # pylint: disable=invalid-name


class EditResourceDialog:
    """Modal dialog for updating one player's resource values."""
    ...
    def __init__(self, parent, player_name, resources):
        ...
        # Center the dialog
        dialog_x = int(parent.winfo_rootx() + parent.winfo_width() / 2 - 150)
        dialog_y = int(parent.winfo_rooty() + parent.winfo_height() / 2 - 100)
    ...
    def ok(self):
        ...
        except (RuntimeError, TK_ERROR) as e:
...
class SaveGameGUI:  # pylint: disable=too-many-instance-attributes
    """Main application window for browsing and editing save files."""
    ...
    def __init__(self, root):
        ...
        self.tree = ttk.Treeview(
            self.tree_frame,
            columns=("Player", "Carbon", "Food", "Nova", "Ore"),
            show="headings",
            selectmode="browse",
        )
    ...
    def browse_file(self):
        ...
        filetypes = [("SWGB Save Files", "*.ga2"), ("All Files", "*.*")]
